...
function MageNuggetsClassicMoonkin_OnUpdate(self, elapsed)
...
function MageNugMoonSize()
    ...
    if (tempInt == 0) then
        ...
        MageNuggetsClassic.moonkinSize = 0;
    elseif (tempInt == 1) then
       ...
       MageNuggetsClassic.moonkinSize = 1;
    elseif (tempInt == 2) then
        ...
        MageNuggetsClassic.moonkinSize = 2;
    elseif (tempInt == 3) then
        ...
        MageNuggetsClassic.moonkinSize = 3;
    elseif (tempInt == 4) then
        ...
        MageNuggetsClassic.moonkinSize = 4;
    elseif (tempInt == 5) then
        ...
        MageNuggetsClassic.moonkinSize = 5;
    elseif (tempInt == 6) then
        ...
        MageNuggetsClassic.moonkinSize =  6;
    elseif (tempInt == 7) then
        ...
        MageNuggetsClassic.moonkinSize =  7;
    elseif (tempInt == 8) then
        ...
        MageNuggetsClassic.moonkinSize =  8;
    elseif (tempInt == 9) then
        ...
        MageNuggetsClassic.moonkinSize =  9;
    elseif (tempInt == 10) then
        ...
        MageNuggetsClassic.moonkinSize =  10;
    end
end
...
function MNmoonkinCombatToggle()
    ...
    if (isChecked == true) then
        MageNuggetsClassic.moonkinCombat = true;
...
function TreantSoundToggle()
    ...
    if (isChecked == true) then
        ...
        MageNuggetsClassic.treantSoundTog = false;
    end
end
...
function MNmoonkinCombatTextToggle()
    ...
    if (isChecked == true) then
        ...
        MageNuggetsClassic.moonkinCombatText = false;
    end
end
...
function MNmoonkinAnchorToggle()
    ...
    if (isChecked == true) then
        ...
        MageNuggetsClassic.moonkinAnchorTog = false;
...
function MNmoonkinminimalToggle()
    ...
    if (isChecked == true) then
        MageNuggetsClassic.moonkinMin = true;
